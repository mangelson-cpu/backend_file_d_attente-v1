...
--
-- Name: update_kiosk_password(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_kiosk_password(p_password text, p_agence_id uuid DEFAULT NULL::uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: update_user_secure(uuid, text, text, text, text, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_user_secure(p_user_id uuid, p_email text, p_password text, p_nom_user text, p_role text, p_agence_id uuid DEFAULT NULL::uuid, p_old_password text DEFAULT NULL::text) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'auth', 'extensions'
    AS $$
DECLARE
...
--
-- Name: verify_kiosk_password(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.verify_kiosk_password(p_agence_id uuid, p_password text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'extensions', 'auth'
    AS $$
DECLARE
...
--
-- Name: agence_priority; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: agence_settings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: agence_priority agence_priority_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_priority
    ADD CONSTRAINT agence_priority_pkey PRIMARY KEY (id);


--
-- Name: agence_priority agence_priority_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_priority
    ADD CONSTRAINT agence_priority_unique UNIQUE (agence_id, priority_id);


--
-- Name: agence_settings agence_settings_agence_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_settings
    ADD CONSTRAINT agence_settings_agence_id_key UNIQUE (agence_id);


--
-- Name: agence_settings agence_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_settings
    ADD CONSTRAINT agence_settings_pkey PRIMARY KEY (id);
...
--
-- Name: agence_priority agence_priority_agence_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_priority
    ADD CONSTRAINT agence_priority_agence_id_fkey FOREIGN KEY (agence_id) REFERENCES public.agence(id) ON DELETE CASCADE;


--
-- Name: agence_priority agence_priority_priority_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_priority
    ADD CONSTRAINT agence_priority_priority_id_fkey FOREIGN KEY (priority_id) REFERENCES public.priority(id) ON DELETE CASCADE;


--
-- Name: agence_settings agence_settings_agence_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agence_settings
    ADD CONSTRAINT agence_settings_agence_id_fkey FOREIGN KEY (agence_id) REFERENCES public.agence(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.ticket
    ADD CONSTRAINT ticket_priority_id_fkey FOREIGN KEY (priority_id) REFERENCES public.priority(id) ON DELETE SET NULL;
...
--
-- Name: app_settings Super admin write app_settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Super admin write app_settings" ON public.app_settings USING ((EXISTS ( SELECT 1
   FROM public.users
...
--
-- Name: agence_priority; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.agence_priority ENABLE ROW LEVEL SECURITY;

--
-- Name: agence_priority agence_priority_delete_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agence_priority_delete_policy ON public.agence_priority FOR DELETE USING (((( SELECT users.role
   FROM public.users
...
--
-- Name: agence_priority agence_priority_insert_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agence_priority_insert_policy ON public.agence_priority FOR INSERT WITH CHECK (((( SELECT users.role
   FROM public.users
  WHERE (users.id = auth.uid())) = 'super_admin'::text) OR ((( SELECT users.role
   FROM public.users
  WHERE (users.id = auth.uid())) = 'admin'::text) AND (agence_id = ( SELECT users.agence_id
...
--
-- Name: agence_priority agence_priority_select_policy; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: agence_priority agence_priority_update_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agence_priority_update_policy ON public.agence_priority FOR UPDATE USING (((( SELECT users.role
   FROM public.users
  WHERE (users.id = auth.uid())) = 'super_admin'::text) OR ((( SELECT users.role
   FROM public.users
  WHERE (users.id = auth.uid())) = 'admin'::text) AND (agence_id = ( SELECT users.agence_id
...
--
-- Name: agence_settings; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.agence_settings ENABLE ROW LEVEL SECURITY;

--
-- Name: agence_settings agence_settings_select_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agence_settings_select_policy ON public.agence_settings FOR SELECT USING (((( SELECT users.role
   FROM public.users
...
--
-- Name: priority priority_delete_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY priority_delete_policy ON public.priority FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'super_admin'::text)))));


--
-- Name: priority priority_insert_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY priority_insert_policy ON public.priority FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'super_admin'::text)))));


--
-- Name: priority priority_select_public_policy; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: priority priority_update_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY priority_update_policy ON public.priority FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND (users.role = 'super_admin'::text)))));
